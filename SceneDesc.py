...
from keras.layers import LSTM, Embedding, TimeDistributed, Dense, RepeatVector, Activation, Concatenate
...
class scenedesc():
	...
	def values(self):
		...
		for token in tokens:
		    vocab.extend(token)
		#print ("Vocab : ",vocab[0:5],len(vocab),"\nTokens : ",tokens[0:5])
			...
			for caption in self.captions:
			    ...
			    for i in range(len(caption.split())-1):
			        ...
			        if total_count>=batch_size:
			            ...
			            total_count = 0
			            print(images,partial_captions,next_words)
